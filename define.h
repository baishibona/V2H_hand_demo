...
#define AI0_DESC_NAME               "yolox_cam_vga"
#define AI1_DESC_NAME               "hrnet_hand_vga"
...
#define IMAGE_OUTPUT_WIDTH          (640) //1280
#define IMAGE_OUTPUT_HEIGHT         (480) //720
...
/*DRP-AI Input image information*/
#ifdef CAM_INPUT_VGA
#define DRPAI_OUT_WIDTH             (640) //960
#define DRPAI_OUT_HEIGHT            (480) //720
#else
...
#define CHAR_SCALE_LARGE            (0.4)
#define CHAR_SCALE_SMALL            (0.3)
#define CHAR_THICKNESS              (1)
#define LINE_HEIGHT                 (20) /*in pixel*/
#define LINE_HEIGHT_OFFSET          (10) /*in pixel*/
#define TEXT_WIDTH_OFFSET           (10) /*in pixel*/
#define TEXT_WIDTH_OFFSET_L         (20) /*in pixel*/
